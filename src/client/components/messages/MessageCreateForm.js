...
class MessageCreateForm extends Component {
    ...
    async componentDidMount() {
        let RID = this.props.recipientId;
                ...
                <Card className={classes.card}>
                    ...
                    <CardContent>
                        <form method="post" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            {/*<Field component="textarea" rows="10" type="text" name="body" label="Business Description" />*/}
                            <br />
                            <div className={classes.btnDiv}>
                                <Button className={classes.btn} type="submit" variant="raised" color="primary">Send Message</Button>
                            </div>
                        </form>
                    </CardContent>
...
MessageCreateForm = connect(null, mapDispatchToProps)(withStyles(styles)(MessageCreateForm));

export default reduxForm({
    form: 'MessageCreateForm', // a unique identifier for this form
